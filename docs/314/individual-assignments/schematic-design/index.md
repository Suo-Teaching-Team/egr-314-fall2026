---
title: Team/Individual -- Schematic Design
---

While this is a team assignment, each member should design their subsystem schematic and then they should be compiled into one schematic to submit. It’s vital that everyone uses the same software to design their subsystems. 
...
While this is a team assignment, it is crucial to your engineering development that you are able to individually demonstrate proficiency in using ECAD software (Electrical Computer-Aided Design) to create a schematic for the subsystem(s) you are responsible for in the project
...
1. Collaborate with your team to make a single, cohesive schematic.
...
Please prepare this assignment as a new "schematic" page on your team github webpage 
...
> Do not link to *living documents*, such as google docs, draw.io drawings, or google sheets.   Rather the the .pdf and .zip documents should be exported, saved in your repository, and hosted on the github site itself.
